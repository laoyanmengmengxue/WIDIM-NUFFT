...
OUT_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "results_gt")
...
def save_results_txt(results_list, out_path):
    with open(out_path, "w", encoding="utf-8") as f:
        f.write("=" * 72 + "\n")
        f.write("Ground-Truth Vorticity Comparison Results\n")
        ...
        for r in results_list:
            ...
            f.write(f"  N (SNR-pass windows): {r['N']}\n")
...
def main():
    ...
    print("=" * 60)
    print("Ground-Truth Vorticity Comparison")
